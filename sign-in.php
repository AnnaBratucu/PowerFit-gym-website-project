...
<body>
    ...
    <form onsubmit="return visitPage()" action="/index.php" method="post">
		...
		<input type="password" name="rp" placeholder="Retype Password" required="required" />
		<input type="date" name="b" id="code" placeholder="Birthday"  required="required" />
