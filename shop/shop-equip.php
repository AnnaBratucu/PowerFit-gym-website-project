	...
	<!-- side -->
      ...
      <div class="col-md-3" id="leftCol">
        <ul class="nav nav-stacked" id="sidebar">
          <li>Clothes</li>
		  <li>
              <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"><a href="shop.php">Women</a></span>
		
            </li>
			<li>
              <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"><a href="shop-men.php">Men</a></span>
		
            </li>
		  
          <li><a href="shop-food.php">Food</a></li>
          <li><a href="shop-acc.php">Accessories</a></li>
          <li><a href="shop-equip.php">Equipment</a></li>
		...
		<div id="products">
			<ul>
				<li>
					<div class="product-image">
						<img src="runn.jpg" alt="" />
					</div>
					<div class="product-description" data-name="Running Band" data-price="5">
						<h3 class="product-name">Run Band</h3>
				...
				<li>
					...
					<div class="product-description" data-name="Bicycle" data-price="8">
						<h3 class="product-name">Bicycle</h3>
				...
				<li>
					...
					<div class="product-description" data-name="Gravity Boots" data-price="11">
						<h3 class="product-name">Boots</h3>
			...
			<ul>
				<li>
					...
					<div class="product-description" data-name="Medicine Ball" data-price="5">
				...
				<li>
					...
					<div class="product-description" data-name="Weights" data-price="8">
						<h3 class="product-name">Weights</h3>
						<p class="product-price">&euro; 13</p>
						<form class="add-to-cart" action="cart.php" method="post">
							<div>
								<label for="qty-2">Quantity</label>
								<input type="text" name="qty-2" id="qty-2" class="qty" value="1" />
				...
				<li>
					...
					<div class="product-description" data-name="Hammer Strength" data-price="11">
						<h3 class="product-name">Strength</h3>
