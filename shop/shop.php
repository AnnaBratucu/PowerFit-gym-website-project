...
<div id="site">
	<!-- Navigation -->
  <nav class=" page-scroll navbar navbar-custom " id="navv" role="navigation">
    <div class="container">
		...
		<div id="products">
			<ul>
				<li>
					...
					<div class="product-description" data-name="Top" data-price="5">
						<h3 class="product-name">Top</h3>
				...
				<li>
					...
					<div class="product-description" data-name="Pants" data-price="8">
						<h3 class="product-name">Pants</h3>
				...
				<li>
					...
					<div class="product-description" data-name="Shoes" data-price="11">
...
<!-- Theme JavaScript -->
  <script src="js/powerfit.js"></script>
