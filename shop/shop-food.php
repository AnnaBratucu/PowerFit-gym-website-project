		...
		<div id="products">
			<ul>
				<li>
					...
					<div class="product-description" data-name="Pasta" data-price="5">
				...
				<li>
					...
					<div class="product-description" data-name="Salad" data-price="8">
				...
				<li>
					...
					<div class="product-description" data-name="Salad" data-price="11">
						<h3 class="product-name">Salad</h3>
			...
			<ul>
				<li>
					...
					<div class="product-description" data-name="Smoothie" data-price="5">
						<h3 class="product-name">Smoothie</h3>
				...
				<li>
					...
					<div class="product-description" data-name="Fish" data-price="8">
						<h3 class="product-name">Fish</h3>
				...
				<li>
					...
					<div class="product-description" data-name="Fruit Salad" data-price="11">
						<h3 class="product-name">Fruit Salad</h3>
