...
<br>
      ...
      <h1 class="title text-center"> June 2017 </h1>
  <div class="calendar" data-toggle="calendar">
    <div class="row">
      ...
      <div class="col-xs-12 calendar-day calendar-no-current-month">
        <time datetime="2014-06-31">31</time>
      </div>
      ...
      <div class="col-xs-12 calendar-day">
        ...
        <div class="events">
          <div class="event">
            ...
            <div class="desc">
              <p>We will be showing local artists films on our new 16 foot movie screen with feature film last "Carnival Of Souls", come see the new BT, hang out and socialize while enjoying some local talent. FREE event. Concessions, popcorn, soda etc available so come hungry!!</p>
              <p>*This event is all ages welcomed </p>
              <p>Featuring :</p>
              <ul>
    ...
    <div class="row">
      ...
      <div class="col-xs-12 calendar-day">
        ...
        <div class="events">
          <div class="event">
            <h4>Nature Workout 91st Annual Spring Show</h4>
            <div class="desc">
              <p>Come with us to celebrate the nature with a good workout.</p>
            </div>
    ...
    <div class="row">
      ...
      <div class="col-xs-12 calendar-day">
        ...
        <div class="events">
          <div class="event">
            <h4>3 Years of PowerFit</h4>
            <div class="desc">
              <p style="text-align:center;">Come with us to celebrate 3 years of PowerFit <br/>
              Mouse0270 <br/>
